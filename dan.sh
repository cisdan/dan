...
descarga() {
    ...
    echo "ADMbot.sh C-SSR.sh Crear-Demo.sh ID.txt PDirect.py PGet.py POpen.py PPriv.py PPub.py apacheon.sh blockBT.sh budp.sh dns-netflix.sh dropbear.sh fai2ban.sh menu message.txt openvpn.sh paysnd.sh ports.sh python.py shadowsocks.sh slowdns.sh sockspy.sh speed.py squid.sh squidpass.sh ssl.sh tcp.sh ultrahost usercodes v2ray.sh" >/etc/newadm-instalacao

    wget -O /etc/CAT-BOT/BotGen.sh https://raw.githubusercontent.com/DanssBot/Generador-BOT/main/Bot/BotGen.sh &>/dev/null
